    ...
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-9 ftco-animate pb-5">
        <p class="breadcrumbs mb-2">
          ...
          <span>Events & Media <i class="ion-ios-arrow-forward"></i></span>
        </p>
       <h1 class="mb-0 bread">Snapshots of Our Journey</h1>
...
<h2>Our Journey in Pictures</h2>
        ...
        <p class="text-muted">A look back at our cultural programs, festivals, workshops, and community initiatives that have shaped the Academy’s journey across the years.</p>
  ...
  <p class="text-muted pl-3" style="font-size:0.95rem; line-height:1.6;">
    Celebrating the vision, values, and milestones that shaped our institution’s journey.  
    Honoring the leaders and pioneers whose guidance continues to inspire our growth.
  </p>
</div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm rounded h-100">
        <img src="images/foundation.jpg" class="card-img-top" alt="16th Foundation Day">
        <div class="card-body text-center">
          <h5 class="card-title">16th Foundation Day Function</h5>
          <p class="text-muted">9 Photos • 2022</p>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm rounded h-100">
        <img src="images/launch.jpg" class="card-img-top" alt="Academy Launch">
        <div class="card-body text-center">
          <h5 class="card-title">Launching of Academy</h5>
          <p class="text-muted">12 Photos • 2007</p>
          <a href="#" class="btn btn-outline-primary btn-sm">View Album</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm rounded h-100">
        <img src="images/agcm.jpg" class="card-img-top" alt="AGCM 2018">
        <div class="card-body text-center">
          <h5 class="card-title">AGCM</h5>
          <p class="text-muted">4 Photos • 2018</p>
          <a href="#" class="btn btn-outline-primary btn-sm">View Album</a>
        </div>
      </div>
    </div>
